...
│   ├── nlp\_pipeline.py          # Modules 1–5: NLP preprocessing
│   ├── sentiment\_model.py       # Module 6: RoBERTa model
│   ├── lstm\_model.py            # LSTM model (alternate)
│   └── data/
│       └── war\_comments\_10000.csv   # Dataset (10,000 Reddit comments)
│
├── frontend/
│   ├── index.html
│   ├── package.json
...
|**Temporal Analysis**|Tracking how opinion changes over time using the created\_time column|
